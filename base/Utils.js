...
define({
    ...
    'Browser' : {
        ...
        /**
         * 获取浏览器类型及版本
         * @returns {{ie: (number|Array), firefox: (Array|{index: number, input: string}), chrome: (Array|{index: number, input: string}), opera: (Array|{index: number, input: string}), safari: (Array|{index: number, input: string})}}
         */
        'nav' : function(){
